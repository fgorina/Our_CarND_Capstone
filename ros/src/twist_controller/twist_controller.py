...
class Controller(object):
    ...
    def control(self, current_vel, dbw_enabled, linear_vel, angular_vel):
        ...
        # rospy.logwarn("Steer : " + str(steering) + "Speed: " + str(linear_vel)+ " Real Speed:" + str(current_vel))
        ...
        elif throttle < .2 and vel_error < 0:    # too fast, m ust brake
            throttle = 0
