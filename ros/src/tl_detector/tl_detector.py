...
class TLDetector(object):
    ...
    def waypoints_cb(self, waypoints):
        ...
        if not self.waypoints_2d:
            ...
            rospy.logwarn("Waypoints also detected " + str(len(self.waypoints_2d)))


    def traffic_cb(self, msg):
        self.lights = msg.lights
        #rospy.logwarn("Lights received " + str(len(self.lights)))
    ...
    def get_closest_waypoint(self, x, y):
        ''' Returns nearest waypoint idx to a known x, y coordinate
